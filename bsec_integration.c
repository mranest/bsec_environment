/*
 * Based on Bosch BSEC bsec_integration.c sample file
 */
 ...
 */
return_values_init bsec_environment_init(
        float sample_rate,
        float temperature_offset,
        bme680_com_fptr_t bus_write,
        bme680_com_fptr_t bus_read,
        sleep_fct sleep,
 ...
 * @return      none
 */
static void bme680_bsec_read_data(
        int64_t time_stamp_trigger,
        bsec_input_t *inputs,
